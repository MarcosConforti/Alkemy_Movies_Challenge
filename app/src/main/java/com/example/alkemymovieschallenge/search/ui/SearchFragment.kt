...
@AndroidEntryPoint
class SearchFragment : Fragment(), OnMoviesClickListener,SearchView.OnQueryTextListener {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            searchViewModel.getAllMoviesState.collect { movieState ->
                when (movieState) {
                    ...
                    is UIState.Success -> successState(movieState)
    ...
    private fun successState(movieState: UIState.Success<List<UIModel>>) {
        binding.lottieAnimationView.isVisible = false
