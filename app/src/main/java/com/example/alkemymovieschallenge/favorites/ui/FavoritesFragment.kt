...
class FavoritesFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private fun configSearchView() {
        circularButton.setOnClickListener {
            ...
            if (searchView.visibility == View.VISIBLE) {
                val shrinkAnimation =
                    AnimationUtils.loadAnimation(this.requireContext(),
                        R.anim.shrink_out_animation)
                searchView.startAnimation(shrinkAnimation)
                searchView.visibility = View.GONE
            } else {
                val expandAnimation =
                    AnimationUtils.loadAnimation(this.requireContext(),
                        R.anim.expand_in_animation)
    ...
    private fun successState(favorite:UIState.Success<List<UIModel>>) {
        binding.lottieAnimationView.isVisible = false
